...
`-t TIME_RNG` - The time range in number of days to split the data into for longitudinal analysis. The time range can be fractions of a day. Default is `1`.
...
`-e DPI` - The DPI (dots per inch) of the plots. Default is `72`.
